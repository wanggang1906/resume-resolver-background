...
public class ATest03_RedisCRUD {
    ...
    public void connectRedis() {
        jedis=ATest02_RedisUtil.getJedis();
    }
    ...
    public void testRedisPool() {
        ...
        ATest02_RedisUtil.getJedis().set("newname", "test");
        System.out.println(ATest02_RedisUtil.getJedis().get("newname"));

    }

    public static void main(String[] args) {
        ATest03_RedisCRUD test = new ATest03_RedisCRUD();
        test.connectRedis();
        //test.testSort();
        System.out.println("redis操作String：");
        //test.testString();
        System.out.println("redis操作List:");
        test.testList();
    }
}